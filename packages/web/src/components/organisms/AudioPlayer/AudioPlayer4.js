...
import PLAY_MODE from './playMode'
// import '../src/styles/index.less'
import { createRandomNum } from './audioUtils'
// import './example.less'
...
class Demo extends React.PureComponent {
  ...
  onAutoPlayInitLoadPlayList = () => {
    ...
    this.updateParams({
      autoPlayInitLoadPlayList: !params.autoPlayInitLoadPlayList,
    })
  }
  ...
  onClearPriorAudioLists = () => {
    ...
    this.updateParams({
      clearPriorAudioLists: !params.clearPriorAudioLists,
    })
  }
  ...
  changePlayIndex = () => {
    ...
    this.updateParams({
      playIndex: createRandomNum(0, params.audioLists.length - 1),
    })
  }
      ...
      <>
        <section className="settings">
          ...
          <button type="button" onClick={this.onQuietUpdateAudioList}>
            quiet update audio list (dont interrupt current play state) (
            {audioList3.length})
          </button>
