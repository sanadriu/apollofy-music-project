...
export const SUBMIT_FIRST_MODAL = "SUBMIT_FIRST_MODAL";
export const SUBMIT_SECOND_MODAL = "SUBMIT_SECOND_MODAL";
export const SUBMIT_THIRD_MODAL = "SUBMIT_THIRD_MODAL";
export const SUBMIT_REGISTER_MODAL = "SUBMIT_REGISTER_MODAL";
