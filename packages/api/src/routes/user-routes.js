...
const { userController, albumController, trackController,playlistController } = require("../controllers");
...
userRouter.get("/me/playlist",authMiddleware, playlistController.getUserPlaylists);
